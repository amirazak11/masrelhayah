...
import bgImg from '../../img/book.png';
...
export default function HomePage() {
  ...
  let CateData = [
      ...
      icon: Med    },
    {
      ...
      path: 'payments',
      img: air,
      paragrah:`فسك تبقى مضيف طيران انت  فى المكان المناسب 👌🏻👇🏻
      قدم الان واحصل علي منحة الإنجليزي مجانا بعد اختبار تحديد المستوى 😉 + خصم خاص لأول ثلاثة طلاب 👨‍✈️👩‍✈️مستني اييييية 😃
      
      الشروط الأساسيه القبول فى الاكاديميه ✈️
      - التقديم متاح من سن ١٧ سنة ✈️
      - للذكور: الطول لا يقل عن ١٦٠سم 👨‍✈️
      - للاناث : الطول لا يقل عن ١٥٥سم 👩‍✈️
      
      نظام الدراسه 👩‍💻👨‍💻  اختيارك 😊
      👨‍✈️سنه دارسيه مكون من 3ترم
       👩‍✈️
...
<div className="col-xl-3 col-sm-6">
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <div class="modal-body m-auto">
      <img className="rounded modal-img" src={cate.icon} />
      <h3>{cate.title}</h3>
      <p>
        {cate.paragrah}
      </p>
